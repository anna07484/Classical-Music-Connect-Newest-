...
export const mockEvents: Event[] = [
  ...
  },
  {
    ...
    date: "2025-09-28",
    time: "7:30 PM",
    venue: "NY - Metropolitan Opera House",
    priceType: "ticketed",
    price: "$35-295",
    program: [
      "Verdi: La Traviata"
  ...
  },
  {
    ...
    date: "2025-09-27",
    time: "8:00 PM",
    venue: "NY - Brooklyn Academy of Music",
    priceType: "ticketed",
    price: "$25-85",
    program: [
  ...
  },
  {
    ...
    date: "2025-10-06",
    time: "5:00 PM",
    venue: "NY - Holy Trinity Lutheran Church",
    priceType: "free",
    program: [
  ...
  },
  {
    ...
    date: "2025-10-10",
    time: "7:30 PM",
    venue: "NY - Peter Jay Sharp Theater",
    priceType: "free",
    program: [
  ...
  },
  {
    ...
    date: "2025-09-29",
    time: "7:00 PM",
    venue: "NY - Mannes School of Music",
    priceType: "free",
    program: [
  ...
  {
    id: "ny-nysymphonic-001",
    title: "New York Symphonic Ensemble",
    date: "2025-10-01",
    time: "7:00 PM",
    venue: "NY - Merkin Concert Hall",
    priceType: "ticketed",
    price: "$20-40",
    program: [
  ...
  },
  {
    ...
    date: "2025-10-07",
    time: "6:30 PM",
    venue: "NY - Metropolitan Museum of Art",
    priceType: "ticketed",
    price: "$25-45",
    program: [
  ...
  },
  {
    ...
    date: "2025-10-11",
    time: "7:00 PM",
    venue: "NY - St. John's in the Village",
    priceType: "ticketed",
    price: "$20-35",
    program: [
  ...
  },
  {
    ...
    date: "2025-09-26",
    time: "8:00 PM",
    venue: "NY - Corpus Christi Church",
    priceType: "ticketed",
    price: "$25-40",
    program: [
  ...
  },
  {
    ...
    date: "2025-10-05",
    time: "7:30 PM",
    venue: "LA - Colburn School - Zipper Concert Hall",
    priceType: "free",
    program: [
  ...
  {
    id: "la-music-center-001",
    title: "Music Center Recital: Hilary Hahn, Violin",
    date: "2025-10-12",
    time: "8:00 PM",
    venue: "LA - Dorothy Chandler Pavilion",
    priceType: "ticketed",
    price: "$45-125",
    program: [
  ...
  },
  {
    ...
    date: "2025-09-30",
    time: "7:30 PM",
    venue: "LA - USC - Bovard Auditorium",
    priceType: "free",
    program: [
  ...
  },
  {
    ...
    date: "2025-10-25",
    time: "7:30 PM",
    venue: "LA - University of Redlands - Memorial Chapel",
    priceType: "ticketed",
    price: "$25-55",
    program: [
  ...
  },
  {
    ...
    date: "2025-10-11",
    time: "8:00 PM",
    venue: "LA - Pasadena Civic Auditorium",
    priceType: "ticketed",
    price: "$35-95",
    program: [
  ...
  {
    id: "la-santa-monica-001",
    title: "Santa Monica Symphony: Film Music Night",
    date: "2025-10-19",
    time: "7:30 PM",
    venue: "LA - Santa Monica High School Auditorium",
    priceType: "ticketed",
    price: "$15-35",
    program: [
  ...
  },
  {
    ...
    date: "2025-10-08",
    time: "8:00 PM",
    venue: "LA - California Institute of the Arts",
    priceType: "free",
    program: [
  ...
  {
    id: "la-long-beach-001",
    title: "Long Beach Symphony: Gershwin & Bernstein",
    date: "2025-10-04",
    time: "7:30 PM",
    venue: "LA - Carpenter Performing Arts Center",
    priceType: "ticketed",
    price: "$28-75",
    program: [
      "Gershwin: Rhapsody in Blue",
  ...
  {
    id: "la-beverly-hills-001",
    title: "Beverly Hills Auditorium: Chopin Recital",
    date: "2025-10-15",
    time: "7:00 PM",
    venue: "LA - Beverly Hills High School Auditorium",
    priceType: "ticketed",
    price: "$25-50",
    program: [
      "Chopin: Ballades Nos. 1-4",
  ...
  {
    id: "la-orange-county-001",
    title: "Pacific Symphony: Mahler's Fifth",
    date: "2025-11-01",
    time: "8:00 PM",
    venue: "LA - Renée and Henry Segerstrom Concert Hall",
    priceType: "ticketed",
    price: "$35-115",
    program: [
  ...
  },
  {
    ...
    date: "2025-10-20",
    time: "7:30 PM",
    venue: "LA - Pomona College - Bridges Auditorium",
    priceType: "free",
    program: [
  ...
  },
  {
    ...
    date: "2025-11-08",
    time: "7:30 PM",
    venue: "LA - Chapman University - Musco Center",
    priceType: "ticketed",
    price: "$20-45",
    program: [
  ...
  },
  {
    ...
    date: "2025-10-26",
    time: "11:00 AM",
    venue: "LA - Private Home in Beverly Hills",
    priceType: "ticketed",
    price: "$75-125",
    program: [
