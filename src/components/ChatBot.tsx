  ...
  const [messages, setMessages] = useState<ChatMessage[]>([
    {
      id: "1",
      type: "bot",
      message: "Hi! I'm your AI assistant in your listening journey. Ask me about booking tickets, parking information, or explaining any music terms and composers!",
      timestamp: new Date(),
    },
  ]);
        ...
        <CardContent className="flex-1 flex flex-col">
              ...
              {messages.map((message) => (
                ...
                >
                  <div className={`flex gap-2 max-w-[80%] ${message.type === "user" ? "flex-row-reverse" : ""}`}>
                    <div className={`w-8 h-8 rounded-full flex items-center justify-center ${message.type === "user" ? "bg-burgundy text-primary-foreground" : "bg-gold text-burgundy"
                      }`}>
          ...
          <div className="flex gap-2 mt-4">
            <Input
              ...
              placeholder="Ask me to book your tieckets or explaining musical terms"
